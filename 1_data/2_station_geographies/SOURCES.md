...
- Expected date: ~April 2012 — Source: originally scheduled spring 2012 (Progressive Railroading, Railway Technology)
- Coordinates: 25.7910, -80.2550 — Source: latitude.to (GPS coordinates for Miami Central Station)
- initial_DEIS_date: 4/30/01 — NOTE: This is technically a Notice of Intent (NOI/scoping notice), not the DEIS publication itself. Source: Federal Register Vol. 66, Issue 83, April 30, 2001 (document 01-10670): FTA/FDOT/Miami-Dade Transit notice advising that an EIS was being prepared for the Airport/Earlington Heights Connector Project. Scoping comments were due May 30, 2001. The actual DEIS was likely published in 2002 or 2003 (an EIS document is listed in AbeBooks as published in 2003), but no Federal Register notice of availability for the DEIS could be located in web searches. Using the NOI as a proxy per project methodology.
