...
fwrite(dmv_distance, file = "3_output/cleaned_data/distance_calculations/DC_proper_no_purple.csv")
...
fwrite(dmv_distance, file = "3_output/cleaned_data/distance_calculations/DC_proper_purple.csv")
